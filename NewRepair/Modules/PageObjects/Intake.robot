...
Create Intake 
     ...
     Fill in Policy  
     Document upload        ${CURDIR}/${DocPdfPath}      PDF
     Fill in damage info
     Planning
     Summary
     Request complete
...
Fill in General information
     ...
     Sleep   5                                     
     Click element  //span[normalize-space()='Leakage detection']
     Click element  //button[normalize-space()='Proceed']
Fill in person information
     Input text  //input[@placeholder='Postal Code']      3016CH 
     Input text  //input[@placeholder='House Number']      10
     sleep  3
     Click element  //input[@id='female']
     input text     //input[@placeholder='First name duped']    Rafika
     input text     //input[@placeholder='Surname duped']       Demni_auto LD
     Sleep    2    
...
Fill in Policy
    ...
    input text     //input[@placeholder='Policy Nr']    1305
    wait until page contains element        (//input[@placeholder='Damage Nr'])[1]
    Input text    (//input[@placeholder='Damage Nr'])[1]   1225
